...
func main () {
		//Load some Test Data
		People = []Person{
			Person{Id: "1", Name: "Dan", Age: 43, Balance: 1023.00, Email: "daniel@onethirdavenue.com", Address: "2 Langtry Lodge Parkgate"},
			Person{Id: "2", Name: "Gillian", Age: 45, Balance: 10000.05, Email: "gillian@hotmail.com", Address: "3 Somewhere Over the rainbow"},
			Person{Id: "3", Name: "Joshua", Age: 14, Balance: 1000.66, Email: "joshua@gmail.com", Address: "25 Belfast Lane Belfast"},
			Person{Id: "4", Name: "Christian", Age: 9, Balance: 1000.11, Email: "christian@yahoo.com", Address: "The Moon"},
		}
